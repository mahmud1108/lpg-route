        ...
        <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $admin->name }},</h1>
                                            <p>You recently requested to reset your password for your LPG-route
                                                account. Use the button below to reset it. <strong>This password reset
                                                    is only valid for the next 60 minutes.</strong></p>
                                            <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ route('admin-reset-action', $token->token) }}"
                                                                        class="f-fallback button button--green"
                                                                        target="_blank" style="color: white">Reset your
                                                                        password</a>
                                                                </td>
                                                            </tr>
                                                        </table>
